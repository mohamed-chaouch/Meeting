  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mt-6">
      {type === "previous" && previousCalls.length === 0 ? (
        <h1 className="text-black text-sm font-semibold">No Previous Calls</h1>
      ) : type === "upcoming" && upcomingCalls.length === 0 ? (
        <h1 className="text-black text-sm font-semibold">No Upcoming Calls</h1>
        ...
        callRacordings.length === 0 && (
          <h1 className="text-black text-sm font-semibold">No Recordings</h1>
        )
      )}
